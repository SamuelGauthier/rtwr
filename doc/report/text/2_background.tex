...
Test~\autoref{subsec:methods_industry}.
...
% one of the biggest open problems in math.
...
applied extensively in movies is the one from
Tessendorf~\autocite{tessendorf2001simulating} as seen
in~\autoref{subsec:spectral_domain}. This model is also used in most of games
and in Ceto, a former paid Unity package. During our research we came across two
...
outdated (see~\autoref{fig:0ad_water}) compared to the one used in commercial
RTS games like Anno 1800 or Age of Empires~3~\todo[inline]{reference figure from
introduction}. There is an open ticket, \#48 ``Advanced Water
